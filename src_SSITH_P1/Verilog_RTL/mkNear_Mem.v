...
//
// On Wed Feb 12 22:09:09 EST 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mkNear_Mem(CLK,
  ...
  wire [63 : 0] dcache$mem_master_araddr,
		...
		dcache$st_amo_val,
		dcache$word64;
  wire [31 : 0] dcache$pmp_csrs_pmpaddr_write_addr,
		dcache$pmp_csrs_pmpcfg_write_x,
		dcache$req_addr,
		dcache$req_satp;
  ...
  wire [3 : 0] dcache$mem_master_arcache,
	       ...
	       dcache$pmp_csrs_pmpaddr_read_j,
	       dcache$pmp_csrs_pmpaddr_write_j,
  ...
  wire [1 : 0] dcache$mem_master_arburst,
	       ...
	       dcache$pmp_csrs_pmpcfg_read_j,
	       dcache$pmp_csrs_pmpcfg_write_j,
	       dcache$req_op,
	       dcache$req_priv;
  wire dcache$EN_pmp_csrs_pmpaddr_write,
       dcache$EN_pmp_csrs_pmpcfg_write,
       dcache$EN_req,
  ...
  wire [31 : 0] icache$addr,
		icache$pmp_csrs_pmpaddr_read,
		icache$pmp_csrs_pmpaddr_write,
		icache$pmp_csrs_pmpaddr_write_addr,
		icache$pmp_csrs_pmpcfg_read,
		icache$pmp_csrs_pmpcfg_write,
		icache$pmp_csrs_pmpcfg_write_x,
		icache$req_addr,
		icache$req_satp;
  ...
  wire [3 : 0] icache$mem_master_arcache,
	       ...
	       icache$pmp_csrs_pmpaddr_read_j,
	       icache$pmp_csrs_pmpaddr_write_j,
  ...
  wire [1 : 0] icache$mem_master_arburst,
	       ...
	       icache$pmp_csrs_pmpcfg_read_j,
	       icache$pmp_csrs_pmpcfg_write_j,
	       icache$req_op,
	       icache$req_priv;
  wire icache$EN_pmp_csrs_pmpaddr_write,
       icache$EN_pmp_csrs_pmpcfg_write,
       icache$EN_req,
  ...
  reg [31 : 0] v__h1923, v__h1929, v__h2074, v__h2080;
  ...
  // value method pmp_csrs_pmpcfg_read
  assign pmp_csrs_pmpcfg_read = icache$pmp_csrs_pmpcfg_read ;
  assign RDY_pmp_csrs_pmpcfg_read = 1'd1 ;

  // actionvalue method pmp_csrs_pmpcfg_write
  assign pmp_csrs_pmpcfg_write = icache$pmp_csrs_pmpcfg_write ;
  ...
  // value method pmp_csrs_pmpaddr_read
  assign pmp_csrs_pmpaddr_read = icache$pmp_csrs_pmpaddr_read ;
  assign RDY_pmp_csrs_pmpaddr_read = 1'd1 ;

  // actionvalue method pmp_csrs_pmpaddr_write
  assign pmp_csrs_pmpaddr_write = icache$pmp_csrs_pmpaddr_write ;
  ...
  mkMMU_Cache #(.dmem_not_imem(1'd1)) dcache(.CLK(CLK),
					     ...
					     .pmp_csrs_pmpaddr_read_j(dcache$pmp_csrs_pmpaddr_read_j),
					     .pmp_csrs_pmpaddr_write_addr(dcache$pmp_csrs_pmpaddr_write_addr),
					     .pmp_csrs_pmpaddr_write_j(dcache$pmp_csrs_pmpaddr_write_j),
					     .pmp_csrs_pmpcfg_read_j(dcache$pmp_csrs_pmpcfg_read_j),
					     .pmp_csrs_pmpcfg_write_j(dcache$pmp_csrs_pmpcfg_write_j),
					     .pmp_csrs_pmpcfg_write_x(dcache$pmp_csrs_pmpcfg_write_x),
					     ...
					     .EN_pmp_csrs_pmpcfg_write(dcache$EN_pmp_csrs_pmpcfg_write),
					     .EN_pmp_csrs_pmpaddr_write(dcache$EN_pmp_csrs_pmpaddr_write),
					     .RDY_set_verbosity(),
  ...
  mkMMU_Cache #(.dmem_not_imem(1'd0)) icache(.CLK(CLK),
					     ...
					     .pmp_csrs_pmpaddr_read_j(icache$pmp_csrs_pmpaddr_read_j),
					     .pmp_csrs_pmpaddr_write_addr(icache$pmp_csrs_pmpaddr_write_addr),
					     .pmp_csrs_pmpaddr_write_j(icache$pmp_csrs_pmpaddr_write_j),
					     .pmp_csrs_pmpcfg_read_j(icache$pmp_csrs_pmpcfg_read_j),
					     .pmp_csrs_pmpcfg_write_j(icache$pmp_csrs_pmpcfg_write_j),
					     .pmp_csrs_pmpcfg_write_x(icache$pmp_csrs_pmpcfg_write_x),
					     ...
					     .EN_pmp_csrs_pmpcfg_write(icache$EN_pmp_csrs_pmpcfg_write),
					     .EN_pmp_csrs_pmpaddr_write(icache$EN_pmp_csrs_pmpaddr_write),
					     .RDY_set_verbosity(),
					     ...
					     .RDY_tlb_flush(),
					     .pmp_csrs_pmpcfg_read(icache$pmp_csrs_pmpcfg_read),
					     .RDY_pmp_csrs_pmpcfg_read(),
					     .pmp_csrs_pmpcfg_write(icache$pmp_csrs_pmpcfg_write),
					     .RDY_pmp_csrs_pmpcfg_write(),
					     .pmp_csrs_pmpaddr_read(icache$pmp_csrs_pmpaddr_read),
					     .RDY_pmp_csrs_pmpaddr_read(),
					     .pmp_csrs_pmpaddr_write(icache$pmp_csrs_pmpaddr_write),
					     .RDY_pmp_csrs_pmpaddr_write(),
  ...
  assign dcache$pmp_csrs_pmpaddr_read_j = 4'h0 ;
  assign dcache$pmp_csrs_pmpaddr_write_addr = pmp_csrs_pmpaddr_write_addr ;
  assign dcache$pmp_csrs_pmpaddr_write_j = pmp_csrs_pmpaddr_write_j ;
  assign dcache$pmp_csrs_pmpcfg_read_j = 2'h0 ;
  assign dcache$pmp_csrs_pmpcfg_write_j = pmp_csrs_pmpcfg_write_j ;
  assign dcache$pmp_csrs_pmpcfg_write_x = pmp_csrs_pmpcfg_write_x ;
  ...
  assign dcache$EN_pmp_csrs_pmpcfg_write = EN_pmp_csrs_pmpcfg_write ;
  assign dcache$EN_pmp_csrs_pmpaddr_write = EN_pmp_csrs_pmpaddr_write ;
  ...
  assign icache$pmp_csrs_pmpaddr_read_j = pmp_csrs_pmpaddr_read_j ;
  assign icache$pmp_csrs_pmpaddr_write_addr = pmp_csrs_pmpaddr_write_addr ;
  assign icache$pmp_csrs_pmpaddr_write_j = pmp_csrs_pmpaddr_write_j ;
  assign icache$pmp_csrs_pmpcfg_read_j = pmp_csrs_pmpcfg_read_j ;
  assign icache$pmp_csrs_pmpcfg_write_j = pmp_csrs_pmpcfg_write_j ;
  assign icache$pmp_csrs_pmpcfg_write_x = pmp_csrs_pmpcfg_write_x ;
  ...
  assign icache$EN_pmp_csrs_pmpcfg_write = EN_pmp_csrs_pmpcfg_write ;
  assign icache$EN_pmp_csrs_pmpaddr_write = EN_pmp_csrs_pmpaddr_write ;
  ...
  begin
    #0;
    if (RST_N != `BSV_RESET_VALUE) if (EN_dmem_req) $write("dmem.req op ");
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_dmem_req && dmem_req_op == 2'd0) $write("CACHE_LD");
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_dmem_req && dmem_req_op == 2'd1) $write("CACHE_ST");
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_dmem_req && dmem_req_op != 2'd0 && dmem_req_op != 2'd1)
	$write("CACHE_AMO");
    if (RST_N != `BSV_RESET_VALUE) if (EN_dmem_req) $write(" f3 ");
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_dmem_req) $write("'h%h", dmem_req_f3);
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_dmem_req) $write(" addr ", dmem_req_addr, " value ");
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_dmem_req) $write("'h%h", dmem_req_store_value);
    if (RST_N != `BSV_RESET_VALUE) if (EN_dmem_req) $write("\n");
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h1923 = v__h1929 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_reset && NOT_cfg_verbosity_read_ULE_1___d9)
	$display("%0d: Near_Mem.rl_reset", v__h1923);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_reset_complete && NOT_cfg_verbosity_read_ULE_1___d9)
	$display("%0d: Near_Mem.rl_reset_complete", v__h2074);
  end
  // synopsys translate_on
