...
//
// On Tue Feb 18 15:18:12 EST 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mkGPR_RegFile(CLK,
  ...
  // value method read_rs1
  assign read_rs1 =
	     { (read_rs1_rs1 == 5'd0) ? 32'd0 : regfile_data$D_OUT_3,
  ...
  assign read_rs1_port2 =
	     { (read_rs1_port2_rs1 == 5'd0) ? 32'd0 : regfile_data$D_OUT_2,
  ...
  // value method read_rs2
  assign read_rs2 =
	     { (read_rs2_rs2 == 5'd0) ? 32'd0 : regfile_data$D_OUT_1,
  ...
  // submodule regfile_data
  assign regfile_data$ADDR_1 = read_rs2_rs2 ;
  assign regfile_data$ADDR_2 = read_rs1_port2_rs1 ;
  assign regfile_data$ADDR_3 = read_rs1_rs1 ;
  assign regfile_data$ADDR_4 = 5'h0 ;
